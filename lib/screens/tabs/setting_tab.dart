          ...
          child: Column(
            children: [
              ListTile(
                ...
                trailing: const Text('ไทย', style: TextStyle(color: Colors.grey)),
                onTap: () {
                  // TODO: เปิดหน้าต่าง/Dialog เปลี่ยนภาษา
                },
              ),
              const Divider(height: 1), // เส้นคั่นระหว่างรายการใน Card เดียวกัน
              ListTile(
                leading: const Icon(Icons.currency_exchange_rounded),
                title: const Text('สกุลเงินเริ่มต้น'),
                trailing: const Text('THB (฿)', style: TextStyle(color: Colors.grey)),
                onTap: () {
